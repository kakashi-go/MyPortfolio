import { GetterTree, MutationTree, CommitOptions, Dispatch, DispatchOptions, Store, ActionTree } from 'vuex';
...
declare const getStoreType: <T extends Record<string, any>, G, M, A, S extends Record<string, Partial<NuxtStore>>>(store: NuxtStoreInput<T, G, M, A, S>) => {
...
declare const getAccessorFromStore: (pattern: any) => (store: Store<any>) => MergedStoreType<Partial<NuxtStoreInput<Record<string, any>, GetterTree<Record<string, any>, any>, MutationTree<Record<string, any>>, ActionTree<Record<string, any>, any>, Record<string, Partial<NuxtStore>>>> & BlankStore, string>;
